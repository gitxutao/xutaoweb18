<template>
  <div class="main">
    <div class="eheader">
      <Eheader title="终端销售交易汇总"></Eheader>
    </div>
    ...
    <div class="main1">
      ...
      >
        ...
        <el-table-column prop="address" label="商品名称" width="139"></el-table-column>
        <el-table-column prop="data1" label="销售数量" width="79"></el-table-column>
        <el-table-column prop="data2" label="销售金额" width="107"></el-table-column>
        <el-table-column prop="data3" label="退款数量" width="119"></el-table-column>
        <el-table-column prop="data4" label="退款金额" width="79"></el-table-column>
        <el-table-column prop="data5" label="数量小计" width="77"></el-table-column>
        <el-table-column prop="data6" label="金额小计" width="89"></el-table-column>
      </el-table>
    </div>
    <div class="block">
      <el-pagination
