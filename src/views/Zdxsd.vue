  ...
  <div class="main">
    ...
    <div class="main1">
      ...
      >
        ...
        <el-table-column prop="name" label="下单时间" width="180"></el-table-column>
        <el-table-column prop="address" label="会员手机" width="90"></el-table-column>
        <el-table-column prop="data1" label="订单金额"></el-table-column>
        <el-table-column prop="data2" label="门店名称" width="150"></el-table-column>
        <el-table-column prop="data3" label="终端编码" width="80"></el-table-column>
        <el-table-column prop="data4" label="收银人员" width="80"></el-table-column>
        <el-table-column prop="data5" label="状态" width="80"></el-table-column>
        <el-table-column fixed="right" label="操作" width="50">
          <template3>
            <el-button type="text" size="small">
              <router-link to="/zdxq" tag="div">详情</router-link>
            </el-button>
          </template3>
        </el-table-column>
      </el-table>
