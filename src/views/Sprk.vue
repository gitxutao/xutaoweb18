<template>
  <div class="main">
    ...
    <el-row class="btn">
      ...
      <el-button type="primary"><router-link to="/sprkadd" tag="div">新增</router-link></el-button>
    ...
    <div class="main1">
      <el-table :data="tableData" border style="width: 100%"
       header-cell-style="background: rgba(242, 242, 242, 1);">
        <el-table-column prop="date" label="入库单号" width="150"></el-table-column>
        <el-table-column prop="name" label="入库门店" width="130"></el-table-column>
        <el-table-column prop="address" label="入库类型"></el-table-column>
        <el-table-column prop="data1" label="入库数量"></el-table-column>
        <el-table-column prop="data2" label="经办人员"></el-table-column>
        <el-table-column prop="data3" label="制单人员" width="110"></el-table-column>
        <el-table-column prop="data4" label="制单日期"></el-table-column>
        <el-table-column prop="data5" label="审核状态"></el-table-column>
        <el-table-column fixed="right" label="操作" width="150">
          <template3>
            <el-button type="text" size="small"><router-link to="/sprkUp" tag="div">修改</router-link></el-button>
            <el-button type="text" size="small"><router-link to="/sprkSee" tag="div">详情</router-link></el-button>
