<template>
  <div class="main">
    ...
    <el-input placeholder="请输入员工姓名/编码" v-model="input3" class="input-with-select">
      <el-button
        slot="append"
        icon="el-icon-search"
        type="primary"
    ...
    <div class="main1">
      ...
      >
        ...
        <el-table-column prop="name" label="登录工号" width="130"></el-table-column>
        <el-table-column prop="address" label="姓名" width="130"></el-table-column>
        <el-table-column prop="data1" label="登录时间" width="178"></el-table-column>
        <el-table-column prop="data2" label="登录IP" width="180"></el-table-column>
        <el-table-column prop="data3" label="登录地址" width="180"></el-table-column>
      </el-table>
    </div>
    <div class="block">
      <el-pagination
