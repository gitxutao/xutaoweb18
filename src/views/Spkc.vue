  ...
  <div class="main">
    ...
    <el-dropdown trigger="click" class="xlk1">
      ...
      <el-dropdown-menu slot="dropdown">
        ...
        <el-dropdown-item>烟酒糖茶</el-dropdown-item>
        <el-dropdown-item>烟</el-dropdown-item>
        <el-dropdown-item>酒水</el-dropdown-item>
        <el-dropdown-item>饮料</el-dropdown-item>
        <el-dropdown-item>茶叶</el-dropdown-item>
        <el-dropdown-item>家居家纺</el-dropdown-item>
        <el-dropdown-item>服装鞋帽</el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
    ...
    <div class="main1">
      ...
      >
        <el-table-column prop="date" label="出库单号" width="150"></el-table-column>
        <el-table-column prop="name" label="出库门店" width="130"></el-table-column>
        <el-table-column prop="address" label="出库类型" width="90"></el-table-column>
        <el-table-column prop="data1" label="出库数量"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="120">
          <template3>
            <el-button type="text" size="small">
              <router-link to="/spckUp" tag="div">修改</router-link>
            </el-button>
          </template3>
        </el-table-column>
      </el-table>
