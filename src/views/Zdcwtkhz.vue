<template>
  <div class="main">
    <div class="eheader">
      <Eheader title="终端财务退款汇总"></Eheader>
    </div>
    ...
    <div class="main1">
      ...
      >
        ...
        <el-table-column prop="name" label="现金笔数" width="90"></el-table-column>
        <el-table-column prop="address" label="现金金额" width="119"></el-table-column>
        <el-table-column prop="data1" label="支付宝笔数" width="99"></el-table-column>
        <el-table-column prop="data2" label="支付宝金额" width="107"></el-table-column>
        <el-table-column prop="data3" label="微信笔数" width="105"></el-table-column>
        <el-table-column prop="data4" label="微信金额" width="100"></el-table-column>
        <el-table-column prop="data5" label="银行卡笔数" width="97"></el-table-column>
        <el-table-column prop="data6" label="银行卡金额" width="101"></el-table-column>
      </el-table>
    </div>
    <div class="block">
      <el-pagination
