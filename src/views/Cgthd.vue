<template>
  <div class="main">
    ...
    <el-row class="btn">
      ...
      <el-button type="primary"><router-link to="/cgthdAdd" tag="div">新增</router-link></el-button>
    ...
    <div class="main1">
      <el-table :data="tableData" border style="width: 100%"
       header-cell-style="background: rgba(242, 242, 242, 1);">
        <el-table-column prop="date" label="采购退货单号" width="150"></el-table-column>
        <el-table-column prop="name" label="供应商" width="130"></el-table-column>
        <el-table-column prop="address" label="退货金额"></el-table-column>
        <el-table-column prop="data1" label="关联单号"></el-table-column>
        ...
        <el-table-column prop="data5" label="出库状态"></el-table-column>
        <el-table-column fixed="right" label="操作" width="150">
          <template3>
            <el-button type="text" size="small"><router-link to="/cgthdUp" tag="div">修改</router-link></el-button>
            <el-button type="text" size="small"><router-link to="/cgthdSee" tag="div">详情</router-link></el-button>
